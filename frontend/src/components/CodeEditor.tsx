...
//   targetRepo: string | null; 
//   isReadOnly?: boolean; 
//   disableTracker?: boolean; // --- Prop to shut off the AI tracker for Founders ---
// }

// const CodeEditor: React.FC<CodeEditorProps> = ({ fileName, userName, yDoc, provider, targetRepo, isReadOnly, disableTracker }) => {
//   const { mode } = useMode(); 
//   const [editorInstance, setEditorInstance] = useState<any>(null);
//   const bindingRef = useRef<any>(null);
...
//   // --- AI FOCUS TRACKER EFFECT ---
//   useEffect(() => {
//     // --- IF TRACKER IS DISABLED (e.g. Founder Mode), ABORT COMPLETELY ---
