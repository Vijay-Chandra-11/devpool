...
// //         // FIX: Extract text from the global yDoc using the filenames from the map!
...
// //     try {
// //         // Simulating the API call for now (Will connect to Flask later)
// //         setTimeout(() => {
// //             setOutput([
// //                 `✅ Successfully committed to GitHub!`,
// //                 `Commit Message: "${commitMessage}"`,
...
// const CodeEditor: React.FC<CodeEditorProps> = ({ fileName, userName, yDoc, provider }) => {
//   // FIX: We changed editorRef to a state variable so React knows exactly when Monaco finishes loading!
...
//   const handleEditorDidMount: OnMount = (editor) => {
//     setEditorInstance(editor); // This triggers the useEffect below!
//   };

//   useEffect(() => {
//     // FIX: We now wait for editorInstance to be fully loaded before binding
...
//         return () => websocket.removeEventListener('message', handleMessage);
//     }
//   }, [fileName, yDoc, provider, editorInstance]); // Added editorInstance to dependencies
